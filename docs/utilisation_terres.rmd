...
df <- data.frame()
for (y in c(2012:2014, 2016, 2018:2019)) {
    t <- read.table(paste0("/home/local/USHERBROOKE/juhc3201/BDQC-GEOBON/data/g15_indicators/results/MELCCFP/MELCCFP_pix_per_land_type_", y, "_version2.txt"))
    df <- rbind(df, t)
}
